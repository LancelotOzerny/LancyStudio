...
<nav class="navbar navbar-expand-lg navbar-light bg-light border-bottom position-sticky w-100">
    <div class="container d-flex justify-content-between">
        <a class="navbar-brand" href="#">
            <img src="assets/images/logo.png" alt="Lancy" width="64">
        </a>
        ...
        <a class="profile d-flex align-items-center text-dark" href="#">
            ...
            <img src="assets/images/empty_profile_icon.png" alt="profile" width="64">
        </a>
    </div>
</nav>
...
<div class="page-block border-bottom">
    <div class="container">
        ...
        <div class="row pt-md-5 flex-lg-row-reverse">
            <div class="col-12 col-lg-4 mb-5 mb-lg-0 d-flex align-items-center">
                <div class="d-flex justify-content-center">
                    <img class="rounded-circle" style="max-width: 100%" src="assets/images/profile.png" alt="Profile Image">
                </div>
            </div>
            <div class="col-12 col-lg-8 text-indent-25 text-justify">
